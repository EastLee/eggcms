      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="error-container">
            ...
            <div class="error-description">您正在寻找的网页可能已被移除。</div>
            <div class="error-goback-text">你想回家吗？</div>
            <div class="error-goback-button"><a href="/" class="btn btn-xl btn-primary">返回</a></div>
            <div class="footer">&copy; 2017 EggCms</div>
          </div>
        </div>
      </div>
    </div>
