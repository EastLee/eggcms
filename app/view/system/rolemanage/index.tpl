...
{% block head %}
  <head>
    ...
    <title>角色管理 - EggCMS - 基于Eggjs的内容管理系统</title>
                  ...
                  <table class="table table-striped table-borderless">
                    <thead>
                      <tr>
                        ...
                        <th class="actions" style="width:20%;">角色名称</th>
                        <th class="actions" style="width:30%;">角色描述</th>
                    ...
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td class="actions">yes</td>
                        <td class="actions">
                            <div class="btn-group btn-space">
                                <button type="button" class="btn btn-default">权限设置</button>
                                <button type="button" class="btn btn-default">栏目权限</button>
                                <button type="button" class="btn btn-default">成员管理</button>
