...
{% block head %}
  <head>
    ...
    <title>创建模型 - EggCMS - 基于Eggjs的内容管理系统</title>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default">
                <div class="panel-heading panel-heading-divider">创建模型</div>
                <div class="panel-body">
                  <form action="#" class="form-horizontal group-border-dashed">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">模型名称</label>
                      <div class="col-sm-6">
                        <input type="text" required="" data-parsley-minlength="6" placeholder="请输入模型名称" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">模型表键名</label>
                      <div class="col-sm-6">
                        <input type="text" required="" data-parsley-maxlength="6" placeholder="请输入模型表键名" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
