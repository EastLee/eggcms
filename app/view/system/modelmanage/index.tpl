...
{% block head %}
  <head>
    ...
    <title>模型管理 - EggCMS - 基于Eggjs的内容管理系统</title>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">模型管理</div>
                <div class="panel-body">
                  <table class="table table-striped table-borderless">
                    <thead>
                      <tr>
                        <th class="actions" style="width:6%;">ModelID</th>
                        <th class="actions" style="width:6%;">模型名称</th>
                        <th class="actions">数据表</th>
                        <th class="actions">描述</th>
                        <th class="actions">状态</th>
                        <th class="actions" style="width:30%;">管理操作</th>
                      </tr>
                    </thead>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td class="actions">OK</td>
                        <td class="actions">
                            <div class="btn-group btn-space">
                                <button type="button" class="btn btn-default">修改</button>
                                <button type="button" class="btn btn-default">字段管理</button>
                                <button type="button" class="btn btn-default">禁用</button>
                                <button type="button" class="btn btn-default">删除</button>
                                <button type="button" class="btn btn-default">导出模型</button>
                             </div>
                        </td>
                      </tr>
                    </tbody>
